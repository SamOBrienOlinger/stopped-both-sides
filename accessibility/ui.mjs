...
export function createReadingTools({main,rerender,siteRole='public'}){
 ...
 function applyDisplay(){
  ...
  document.querySelectorAll('[data-reading-open]').forEach(button=>button.textContent=button.classList.contains('utility-settings')?t('Language')+' & '+t('Accessibility'):t('Language & reading'));
 }
